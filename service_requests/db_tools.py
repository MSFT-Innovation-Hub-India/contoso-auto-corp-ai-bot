...
def fetch_customer_information(config: RunnableConfig) -> list[dict]:
    ...
    print(f"Here is the customer's registered information: \n{response_message}")
...
def create_service_appointment_slot(start_date_time, vehicle_id, service_type_id=1):
    """
    ...
    try:
        print(f"Creating the service appointment slot for the customer. vehicle id: {vehicle_id}, service type id: {service_type_id}, start date time: {start_date_time}")
